...
async function Courses() {
    ...
    return (
        <div className='flex flex-col text-sm space-y-4 m-4 w-full'>
            <Card className={`w-4/5 text-sm `}>
                <CardHeader className='flex flex-row justify-between'>
                    <div className="flex flex-row space-x-4">
                        ...
                        <div className="flex flex-col">
                            <CardTitle className='text-base'>Erick Barasa</CardTitle>
                            <CardDescription className='text-xs'>5 min ago</CardDescription>
                        </div>
                    </div>
                    <Button variant="ghost" size="icon">
                        <svg width="20" height="20" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.625 2.5C8.625 3.12132 8.12132 3.625 7.5 3.625C6.87868 3.625 6.375 3.12132 6.375 2.5C6.375 1.87868 6.87868 1.375 7.5 1.375C8.12132 1.375 8.625 1.87868 8.625 2.5ZM8.625 7.5C8.625 8.12132 8.12132 8.625 7.5 8.625C6.87868 8.625 6.375 8.12132 6.375 7.5C6.375 6.87868 6.87868 6.375 7.5 6.375C8.12132 6.375 8.625 6.87868 8.625 7.5ZM7.5 13.625C8.12132 13.625 8.625 13.1213 8.625 12.5C8.625 11.8787 8.12132 11.375 7.5 11.375C6.87868 11.375 6.375 11.8787 6.375 12.5C6.375 13.1213 6.87868 13.625 7.5 13.625Z" fill="currentColor" fill-rule="evenodd" clip-rule="evenodd" data-darkreader-inline-fill=""></path></svg>
                    </Button>
                </CardHeader>
                <CardContent className="grid gap-y-2">
                    <div className="flex flex-col">
                        <p className='text-base font-semibold'>All you need to know about NextJs</p>
                        <p>Description: Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ratione dicta mollitia aliquid soluta laboriosam nam aspernatur a, commodi nesciunt alias cupiditate explicabo autem voluptatem, nobis hic architecto id porro voluptatum.</p>
                    </div>
                </CardContent>
